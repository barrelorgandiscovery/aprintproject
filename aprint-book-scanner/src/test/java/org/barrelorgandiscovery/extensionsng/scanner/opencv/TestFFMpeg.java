...
//		args = new String[] {
//				"C:\\projets\\APrint\\contributions\\plf\\2019-07-19_scan_video_popcorn_52\\20190719_212734.mp4" };
//
...
//				codec_ctx.width(), codec_ctx.height(), AV_PIX_FMT_RGB24, SWS_BILINEAR, null, null,
//				(DoublePointer) null);
//
//		if (sws_ctx == null) {
...
//		}
//
//		av_image_fill_arrays(pFrameRGB.data(), pFrameRGB.linesize(), buffer, AV_PIX_FMT_RGB24, codec_ctx.width(),
//				codec_ctx.height(), 1);
//
//		i = 0;
