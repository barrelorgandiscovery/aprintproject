...
public class ScaleParserV6 implements LineParser {

	private static final Logger logger = Logger.getLogger(ScaleParserV6.class);

	public ScaleParserV6() {
	}
	...
	private boolean bookMovingRightToLeft = false;
	...
	public void lineParsed(String key, String value, int line) throws Exception {
		try {
			...
			} else if ("righttoleft".equals(key)) {
			
				this.bookMovingRightToLeft = Boolean.parseBoolean(value);
