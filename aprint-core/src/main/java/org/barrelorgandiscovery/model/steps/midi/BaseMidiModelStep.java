...
public abstract class BaseMidiModelStep extends ModelStepWithConsole {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4835258732019191700L;
	...
	public BaseMidiModelStep() {
		...
		this.configureParameters = new ModelValuedParameter[] { fromNote, toNote };
	}
