...
import org.barrelorgandiscovery.model.steps.book.BaseVirtualBookModelStep;
 ...
 * 
 */
public class SDVirtualBookMultiplexer extends
		BaseSerDeserHelper<VirtualBookMultiplexer> {

	public Class getHelpedClass() {
		return VirtualBookMultiplexer.class;
	}

	public void toXml(VirtualBookMultiplexer object, XmlSerContext ctx,
	...
	public VirtualBookMultiplexer fromXml(XmlSerContext ctx, Element object)
			throws Exception {
