...
import org.barrelorgandiscovery.virtualbook.x2012.Annotation;
import org.barrelorgandiscovery.virtualbook.x2012.Holes;
import org.barrelorgandiscovery.virtualbook.x2012.PipeStop;
import org.barrelorgandiscovery.virtualbook.x2012.PipeStopSet;
import org.barrelorgandiscovery.virtualbook.x2012.Scale;
import org.barrelorgandiscovery.virtualbook.x2012.ScaleDefinition;
import org.barrelorgandiscovery.virtualbook.x2012.ScaleDocument;
import org.barrelorgandiscovery.virtualbook.x2012.ScaleInformations;
import org.barrelorgandiscovery.virtualbook.x2012.SignatureAnnotation;
import org.barrelorgandiscovery.virtualbook.x2012.TempoAnnotation;
import org.barrelorgandiscovery.virtualbook.x2012.TrackCommandDef;
import org.barrelorgandiscovery.virtualbook.x2012.TrackDef;
import org.barrelorgandiscovery.virtualbook.x2012.TrackDrum;
import org.barrelorgandiscovery.virtualbook.x2012.TrackNoteDef;
import org.barrelorgandiscovery.virtualbook.x2012.TrackRegisterControlResetDef;
import org.barrelorgandiscovery.virtualbook.x2012.TrackRegisterControlStartDef;
import org.barrelorgandiscovery.virtualbook.x2012.TracksDefinition;
import org.barrelorgandiscovery.virtualbook.x2012.VirtualBookDocument;
import org.barrelorgandiscovery.virtualbook.x2012.VirtualBookMetadata;
...
public class XMLConverter2012 {
	...
	private static Logger logger = Logger.getLogger(XMLConverter2012.class);
	...
	public static VirtualBookDocument toVirtualBookDocument(VirtualBook vb)
		...
		org.barrelorgandiscovery.virtualbook.x2012.VirtualBook xmlvb = xmlvbdoc
				.addNewVirtualBook();
		...
		for (Iterator iterator = holes.iterator(); iterator.hasNext();) {
			...
			org.barrelorgandiscovery.virtualbook.x2012.Hole xmlhole = xmlholes
					.addNewHole();
	...
	public static org.barrelorgandiscovery.scale.Scale fromScale(
			org.barrelorgandiscovery.virtualbook.x2012.Scale scale, int maxtrackindex)
			throws Exception {
		...
		maxtrack = Math.max(maxtrack, maxtrackindex);
	...
	public static VirtualBook fromVirtualBookDocument(VirtualBookDocument vbd)
		...
		org.barrelorgandiscovery.virtualbook.x2012.VirtualBook virtualBook = vbd
				.getVirtualBook();
		...
		// compute the max of track, because some books may have no definitions
				...
				int maxTrack = -1;
				org.barrelorgandiscovery.virtualbook.x2012.Hole[] holeArray = virtualBook
						.getHoles().getHoleArray();
				
				for (org.barrelorgandiscovery.virtualbook.x2012.Hole h : holeArray) {
