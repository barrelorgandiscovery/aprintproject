...
import org.barrelorgandiscovery.virtualbook.x2010.Holes;
import org.barrelorgandiscovery.virtualbook.x2010.PipeStop;
import org.barrelorgandiscovery.virtualbook.x2010.PipeStopSet;
import org.barrelorgandiscovery.virtualbook.x2010.Scale;
import org.barrelorgandiscovery.virtualbook.x2010.ScaleDefinition;
import org.barrelorgandiscovery.virtualbook.x2010.ScaleDocument;
import org.barrelorgandiscovery.virtualbook.x2010.ScaleInformations;
import org.barrelorgandiscovery.virtualbook.x2010.TrackCommandDef;
import org.barrelorgandiscovery.virtualbook.x2010.TrackDef;
import org.barrelorgandiscovery.virtualbook.x2010.TrackDrum;
import org.barrelorgandiscovery.virtualbook.x2010.TrackNoteDef;
import org.barrelorgandiscovery.virtualbook.x2010.TrackRegisterControlResetDef;
import org.barrelorgandiscovery.virtualbook.x2010.TrackRegisterControlStartDef;
import org.barrelorgandiscovery.virtualbook.x2010.TracksDefinition;
...
public class XMLConverter {
	...
	public static VirtualBookDocument toVirtualBookDocument(VirtualBook vb)
		...
		org.barrelorgandiscovery.virtualbook.x2010.VirtualBook xmlvb = xmlvbdoc
				.addNewVirtualBook();
		...
		for (Iterator iterator = holes.iterator(); iterator.hasNext();) {
			...
			org.barrelorgandiscovery.virtualbook.x2010.Hole xmlhole = xmlholes
					.addNewHole();
	...
	public static org.barrelorgandiscovery.scale.Scale fromScale(
			org.barrelorgandiscovery.virtualbook.x2010.Scale scale, int maxTrackIndex)
			throws Exception {
		...
		org.barrelorgandiscovery.scale.Scale s = new org.barrelorgandiscovery.scale.Scale(
				...
				scale.getInfos().getContact(), rendering, false, false, null);
	...
	public static VirtualBook fromVirtualBookDocument(VirtualBookDocument vbd)
		...
		org.barrelorgandiscovery.virtualbook.x2010.VirtualBook virtualBook = vbd
				.getVirtualBook();
		...
		int maxTrack = -1;
		org.barrelorgandiscovery.virtualbook.x2010.Hole[] holeArray = virtualBook
				.getHoles().getHoleArray();
		
		for (org.barrelorgandiscovery.virtualbook.x2010.Hole h : holeArray) {
