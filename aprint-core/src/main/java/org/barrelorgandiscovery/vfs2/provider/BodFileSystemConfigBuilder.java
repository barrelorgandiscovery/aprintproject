 ...
 * @since 2.3
 */
public class BodFileSystemConfigBuilder extends FileSystemConfigBuilder {

    private static final BodFileSystemConfigBuilder BUILDER = new BodFileSystemConfigBuilder();
     ...
     */
    public static BodFileSystemConfigBuilder getInstance() {
        return BUILDER;
    }

    private BodFileSystemConfigBuilder() {
        super("bod.");
    }
     ...
     */
    protected BodFileSystemConfigBuilder(final String prefix) {
        super(prefix);
    }

    @Override
    protected Class<? extends FileSystem> getConfigClass() {
        return BodFileSystem.class;
    }
