...
/**
 * Feature: Stepwise Motion
 * 
 * Calculates the fraction of melodic intervals that correspond to a minor or major second.
 * 
 * @author APrint Development Team
 */
public class StepwiseMotionFeature extends VirtualBookFeatureExtractor {
	
	public StepwiseMotionFeature() {
		this.code = "M-11";
		this.name = "Stepwise Motion";
		this.description = "Fraction of melodic intervals that correspond to a minor or major second.";
	}
	...
	public double[] extractFeature(VirtualBookFeatureContext context) throws Exception {
		...
		double fraction = (double) stepwiseCount / intervals.size();
