...
package org.barrelorgandiscovery.recognition.imageprocessing;
...
public class WarpGrid {
	...
	/**
	 * set position of a corner
	 * @param row
	 * @param col
	 * @param x
	 * @param y
	 */
	public void setPos(int row, int col, float x, float y)
	{
	...
	protected void interpolateSpline(float[] xKnots, float[] yKnots,
			int offset, int length, float[] splineY, int splineOffset,
			int splineLength) {
		int index = offset;
