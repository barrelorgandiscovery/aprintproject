...
public class DxfFile {
    ...
    // La section CLASSES suivante est posterieure à la version 12 de DXF
    ...
    // La section OBJECTS suivante est posterieure à la version 12 de DXF
    public final static DxfGroup OBJECTS = new DxfGroup(2, "OBJECTS");
    // Schema de données général pour les ENTITIES
