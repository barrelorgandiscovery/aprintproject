...
public class DXFParametersBeanInfo extends BaseBeanInfo {

	public DXFParametersBeanInfo() {
		super(DXFParameters.class);
		...
		taillTrous
				.setShortDescription("Taille Maximum des trous créés, si le trou est plus grand, un pont est créé.\nSi vous ne souhaitez pas de ponts, mettez un grand nombre ici");
...
//		typePont.setCategory("Trous");
		...
		silreste.setShortDescription("On abandonne le dernier pont s'il reste un petite distance intérieure à la valeure saisie (en mm)");
		...
		exportPliures
				.setShortDescription("Export des traits de pliures dans le fichier DXF");
		...
		taillePage
				.setShortDescription("Si les pliures sont sélectionnées, Taille de la page du carton pour réaliser les pliures en mm");
		...
		typePliure
				.setShortDescription("Dessin des pliures (continue, ou pointillé)");
