...
public class CustomImageView extends View {
     ...
     */
    private static final String PENDING_IMAGE = "html.pendingImage"; //$NON-NLS-1$
    /**
     * Property name for missing image icon
     */
    private static final String MISSING_IMAGE = "html.missingImage"; //$NON-NLS-1$

    /**
     * Document property for image cache.
     */
    private static final String IMAGE_CACHE_PROPERTY = "imageCache"; //$NON-NLS-1$
    ...
    protected void setPropertiesFromAttributes() {
        ...
        if (alignment != null) {
            ...
            if ("top".equals(alignment)) { //$NON-NLS-1$
                vAlign = 0f;
            }
            else if ("middle".equals(alignment)) { //$NON-NLS-1$
                vAlign = .5f;
            }
        }
    ...
    public float getPreferredSpan(int axis) {
        ...
        if (image != null) {
            ...
            case View.Y_AXIS:
                return height + topInset + bottomInset;
            default:
                throw new IllegalArgumentException("Invalid axis: " + axis); //$NON-NLS-1$
            }
        }
        else {
            View view = getAltView();
    ...
    private class ImageLabelView extends InlineView {
        ...
        public Segment getText(int p0, int p1) {
            if (p0 < 0 || p1 > segment.array.length) {
                throw new RuntimeException("ImageLabelView: Stale view"); //$NON-NLS-1$
            }
            segment.offset = p0;
            segment.count = p1 - p0;
            return segment;
    ...
    private void loadImage() {
        ...
        if (src != null) {
            ...
            System.out.println("[DEBUG] loadImage() - newImage = null"); //$NON-NLS-1$
    ...
    private String getBASE64Image() {
        ...
        return src.replaceFirst("^.*;base64,", ""); //$NON-NLS-1$ //$NON-NLS-2$
    } // End getBASE64Image()...
