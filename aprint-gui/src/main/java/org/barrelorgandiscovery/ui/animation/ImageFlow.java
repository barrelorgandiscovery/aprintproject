...
public class ImageFlow extends JPanel {
	...
	private static final int CD_SIZE = 300;
...
//		return new Dimension(displayWidth, (int) (displayHeight));
...
//	}
	...
	public Object getSelectedValue() {
		...
		if (avatarIndex >= avatars.size() || avatarIndex < 0)
			return null;
	...
	private class PicturesFinderThread implements Runnable {
		...
		public PicturesFinderThread() {
			try {
				/*
				 * artworks = new LinkedList<File>(); artworks.add(new
				 * File("c:/projects/components/artworks/BlackEyedPeas.jpg"));
				 * avatarsText.add("Black Eyed Peas"); artworks.add(new
				 * File("c:/projects/components/artworks/Coldplay.jpg"));
				 * avatarsText.add("Coldplay"); artworks.add(new
				 * File("c:/projects/components/artworks/Foo Fighters.jpg"));
				 * avatarsText.add("Foo Fighters"); artworks.add(new
				 * File("c:/projects/components/artworks/Gorillaz.jpg"));
				 ...
				 * artworks.add(getClass().getResource("artworks/Sin
				 * City.jpg")); avatarsText.add("Sin City");
				 */
			} catch (Exception e) {
				e.printStackTrace();
			}
		...
		public void run() {
			/*
			 * avatarsText.add("Black Eyed Peas"); avatarsText.add("Coldplay");
			 * avatarsText.add("Foo Fighters"); avatarsText.add("Gorillaz");
			 */
